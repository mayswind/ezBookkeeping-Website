...
| 选项名 | 默认值 | 描述 |
| --- | --- | --- |
| `data_source` | `euro_central_bank` | 汇率数据源，支持 `reserve_bank_of_australia`、`bank_of_canada`、`czech_national_bank`、`danmarks_national_bank`、`euro_central_bank`、`national_bank_of_georgia`、`bank_of_israel`、`norges_bank`、`national_bank_of_poland`、`national_bank_of_romania`、`swiss_national_bank` 或 `international_monetary_fund`。更多信息，请访问 [汇率](/zh_Hans/exchange_rates)。 |

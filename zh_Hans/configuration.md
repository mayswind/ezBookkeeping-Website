...
| 选项名 | 默认值 | 描述 |
| --- | --- | --- |
| `data_source` | `euro_central_bank` | 汇率数据源，支持 `euro_central_bank`、`bank_of_canada`、`reserve_bank_of_australia`、`czech_national_bank`、`national_bank_of_poland`、`bank_of_israel`、`swiss_national_bank`、`danmarks_national_bank` 或 `international_monetary_fund`。更多信息，请访问 [汇率](/zh_Hans/exchange_rates)。 |

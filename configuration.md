...
| Option Name | Default Value | Description |
| --- | --- | --- |
| `data_source` | `euro_central_bank` | Exchange rates data source, supports `euro_central_bank`, `bank_of_canada`, `reserve_bank_of_australia`, `czech_national_bank`, `national_bank_of_poland`, `bank_of_israel` or `international_monetary_fund`. For more information, please visit [Exchange Rates](/exchange_rates). |

...
| `calendarDisplayType` | `CalendarDisplayType` in [`/src/core/calendar.ts`](https://github.com/mayswind/ezbookkeeping/blob/main/src/core/calendar.ts) | The default calendar used by the calendar component and month list, supports `Gregorian` and `Buddhist` |
| `dateDisplayType` | `DateDisplayType` in [`/src/core/calendar.ts`](https://github.com/mayswind/ezbookkeeping/blob/main/src/core/calendar.ts) | The default calendar used when displaying dates, supports `Gregorian` and `Buddhist` |

...
| max_time | int64 | Optional | The maximum time sequence ID (Set to `0` if you want to get the latest transactions) |
| min_time | int64 | Optional | The minimum time sequence ID |
| page | int32 | Optional | Speicifed page number |
| count | int32 | Required | The count of transactions per page (maximum is `50`) |
| with_count | bool | Optional | Whether to get the total count of all transactions |
| with_pictures | bool | Optional | Whether to get the picture IDs |
| trim_account | bool | Optional | Whether to get the account ID instead of account object |
| trim_category | bool | Optional | Whether to get the transaction category ID instead of category object |
| trim_tag | bool | Optional | Whether to get the tag IDs instead of tag object |
...
| nextTimeSequenceId | int64 | The next cursor (`max_time` parameter) when requesting older data |
| totalCount | int64 | The total count of transactions |

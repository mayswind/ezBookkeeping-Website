...
ezBookkeeping 并不是万能的，你可以根据自己最强烈的需求选择最适合自己的软件。ezBookkeeping 最新的功能列表可以在 [功能列表](/zh_Hans/features/) 中查看。
...
| 自定义图表 | ✅ 支持 | ❌ 不支持 | ✅ 支持 |
| 导出图表数据 | ✅ 支持导出 CSV / TSV / Markdown | ❌ 不支持 | ❌ 不支持 |
| 分类图表（饼图） | ✅ 支持 | ✅ 支持 | ✅ 支持 |
...
| 登录频次限制 | ✅ 支持 | ❌ 不支持 | ❌ 不支持 |
| 端到端加密 | 不在客户端存储敏感数据 | 不在客户端存储敏感数据 | ✅ 支持 |

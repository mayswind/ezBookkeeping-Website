...
![如何在 1Panel 中安装 ezBookkeeping](/images/zh_Hans/how_to_install_ezBookkeeping_in_1Panel.png)
...
![如何填写安装 ezBookkeeping 在 1Panel 中的参数](/images/zh_Hans/how_to_fill_in_parameters_when_installing_ezBookkeeping_in_1Panel.png)
